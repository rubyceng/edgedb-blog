...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$country ? _default.$country : 
  T extends _default.$State ? _default.$State : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _default.$country ?
    B extends _default.$country ?
    B
    :
    never
  :
  A extends _default.$State ?
    B extends _default.$State ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::country") {
    if(b.__name__ === "default::country") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::State") {
    if(b.__name__ === "default::State") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
