...
export type $country = {
  "China": $.$expr_Literal<$country>;
  "Other": $.$expr_Literal<$country>;
} & $.EnumType<"default::country", ["China", "Other"]>;
const country: $country = $.makeType<$country>(_.spec, "655581b1-53c2-11ef-ae1b-81f88ea526a9", _.syntax.literal);
...
export type $AuthorλShape = $.typeutil.flatten<$UserλShape & {
...
export { State, country, $Base, Base, $User, User, $Admin, Admin, $Author, Author, $Comment, Comment, $Post, Post, $PostType, PostType, $Tag, Tag };
